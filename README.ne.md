...
### २. ०.४.० मा `django-bikram` बाट नाम फेरिएको

तपाईंले `django-bikram` इन्स्टल गर्नुभएको थियो भने, अब प्याकेज
**`django-bikram-sambat`** र import **`django_bikram_sambat`** हो:
...
```
```python
from django_bikram_sambat import BSDate          # पहिले: django_bikram
```

अरू केही फेरिएको छैन — उही API, उही डेटा, उही व्यवहार। `django_bikram` →
`django_bikram_sambat` खोज-र-फेर गर्नु नै पूरा migration हो। पुरानो नाम अझै
इन्स्टल हुन्छ र यही प्याकेज re-export गर्छ, त्यसैले पुरानो कोड चल्छ — तर त्यसमा
नयाँ release आउँदैन।

नाम फेर्नुको कारण: "Bikram" एक्लै नेपालीमा सामान्य व्यक्तिको नाम हो, त्यसैले
`django-bikram` खोजमा अस्पष्ट थियो र प्याकेजले के गर्छ भन्ने बताउँदैनथ्यो।

import प्याकेज जानाजान `bikram` **होइन**: PyPI मा पहिले नै `bikram` नामको फरक
प्याकेज ([`bikram`](https://pypi.org/project/bikram/), v2.1.4) छ जसले आफ्नै
शीर्ष-तहको `bikram/` फोल्डर हाल्छ। दुई प्याकेजले एउटै import नाम दाबी गर्दा,
दुवै इन्स्टल गर्दा एउटाले अर्कोलाई चुपचाप मेटाउँछ — pip ले चेतावनी दिँदैन।
